            ...
            <div className="relative rounded-[2.5rem] overflow-hidden backdrop-blur-xl bg-gradient-to-br from-white/10 to-white/[0.02] border border-white/20 p-12 lg:p-16">
              ...
              <div className="relative z-10 text-center">
                ...
                >
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white px-10 py-7 rounded-2xl shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 transition-all duration-300 text-lg"
                  >
                    Start Your Project
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white/30 hover:bg-white/10 text-white px-10 py-7 rounded-2xl backdrop-blur-sm transition-all duration-300 text-lg"
                  >
                    Schedule a Call
                  </Button>
                </motion.div>
