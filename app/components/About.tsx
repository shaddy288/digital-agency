export function About() {
  return (
    <section id="about" className="relative py-28 overflow-hidden bg-[#0B0F19]">
      {/* Ambient mesh background */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-[-10%] w-[500px] h-[500px] rounded-full bg-[#7B2FBE]/10 blur-[120px]" />
        <div className="absolute bottom-1/4 right-[-10%] w-[400px] h-[400px] rounded-full bg-[#00D4FF]/8 blur-[120px]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto lg:px-12">
        {/* Label */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            <h2 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-extrabold leading-[1.1] tracking-tight text-white mb-6">
              Your Digital{" "}
            ...
            <div className="grid grid-cols-3 gap-4 mt-10">
              {[
                ...
                <div
                  key={stat.label}
                  className="group p-4 rounded-xl border border-white/8 bg-white/4 backdrop-blur-sm hover:border-[#7B2FBE]/40 hover:bg-[#7B2FBE]/8 transition-all duration-300"
                >
                  <div className="text-2xl font-extrabold bg-gradient-to-br from-white to-white/60 bg-clip-text text-transparent">
                    {stat.value}
                  </div>
                  <div className="text-xs text-white/40 mt-0.5 leading-tight">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          <div className="space-y-5 text-white/65 text-base sm:text-lg leading-relaxed">
            <p>
              ...
              for design, development, marketing, and strategy. <br />
              <br />
            ...
            <div className="flex flex-wrap gap-2 pt-4">
              {[
                ...
                <span
                  key={cap}
                  className="px-3 py-1.5 text-xs font-medium rounded-full border border-white/10 bg-white/5 text-white/60 hover:border-[#00D4FF]/40 hover:text-[#00D4FF] transition-colors duration-200 cursor-default"
                >
                  {cap}
                </span>
              ))}
